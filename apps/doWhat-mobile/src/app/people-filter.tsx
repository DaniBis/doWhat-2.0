  ...
  const renderActivityFilters = () => (
    <ScrollView style={styles.tabContent} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.filterSection}>
        <Text style={styles.filterTitle}>Activity Categories</Text>
      ...
      {/* Time of Day */}
      <View style={styles.filterSection}>
        <Text style={styles.filterTitle}>Time Preference</Text>
        <View style={styles.filterGrid}>
          {timeSlots.map((time) => (
            <TouchableOpacity
              key={time}
              style={[
                styles.filterChip,
                filters.timeOfDay.includes(time) && styles.filterChipActive
              ]}
              onPress={() => toggleFilter('timeOfDay', time)}
            >
              <Text style={[
                styles.filterChipText,
                filters.timeOfDay.includes(time) && styles.filterChipTextActive
              ]}>
                {time}
              </Text>
            </TouchableOpacity>
      ...
      {/* Distance & Price */}
      <View style={styles.filterSection}>
        <Text style={styles.filterTitle}>Distance & Budget</Text>
        <View style={styles.rangeContainer}>
          <View style={styles.rangeItem}>
            <Text style={styles.rangeLabel}>Distance: {filters.radius} miles</Text>
            <View style={styles.rangeButtons}>
              <TouchableOpacity 
                style={styles.rangeButton}
                onPress={() => setFilters(prev => ({...prev, radius: Math.max(1, prev.radius - 5)}))}
              >
                <Text style={styles.rangeButtonText}>-</Text>
              </TouchableOpacity>
              <TouchableOpacity 
                style={styles.rangeButton}
                onPress={() => setFilters(prev => ({...prev, radius: Math.min(50, prev.radius + 5)}))}
              >
                <Text style={styles.rangeButtonText}>+</Text>
              </TouchableOpacity>
            </View>
          ...
          <View style={styles.rangeItem}>
            <Text style={styles.rangeLabel}>Budget: ${filters.priceRange[0]} - ${filters.priceRange[1]}</Text>
            <Text style={styles.rangeSubtext}>Tap to adjust price range</Text>
          </View>
        </View>
      </View>
    </ScrollView>
        ...
        <View style={styles.tabContainer}>
          ...
          >
            <Ionicons 
              name="people" 
              size={18} 
              color={activeTab === 'people' ? '#2C3E50' : 'rgba(255,255,255,0.7)'} 
            />
            <Text style={[
          ...
          >
            <Ionicons 
              name="fitness" 
              size={18} 
              color={activeTab === 'activities' ? '#2C3E50' : 'rgba(255,255,255,0.7)'} 
            />
            <Text style={[
              styles.tabButtonText,
