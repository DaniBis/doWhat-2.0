-- Migration 052: remove activity place label usage and derive labels from places
BEGIN;
...
RETURNS TABLE (
  ...
  SELECT a.id,
         ...
         a.venue,
         a.place_id,
         p.name AS place_label,
         a.lat AS lat_out,
         a.lng AS lng_out,
         ST_DistanceSphere(a.geom, origin.pt) AS distance_m,
         a.activity_types,
         a.tags,
         a.traits
  FROM activities a
