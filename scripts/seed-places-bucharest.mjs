...
const count = process.env.BUCHAREST_TILE_COUNT ? Number.parseInt(process.env.BUCHAREST_TILE_COUNT, 10) : undefined;
...
(async () => {
  ...
  console.info('[seed:places:bucharest]', JSON.stringify(payload, null, 2));
})();
